...
<body>
    <nav>
        ...
        <ul>
            <li onclick="location.href='.'">Menu</li>
        </ul>
    </nav>
    <?php 
    if ($p !="developer") {        
    ...
    <section class="cabecera">
        ...
        <div style="overflow: hidden; width:100%;" class="wave"><svg viewBox="0 0 500 150" preserveAspectRatio="none" style="height: 100%; width: 100%;"><path d="M-43.73,12.33 C-79.28,-7.39 386.84,136.67 504.79,14.30 L500.00,150.00 L0.00,150.00 Z" style="stroke: none; fill: #dbdbdb;"></path></svg></div>
    </section>
    <section class="servicios">
        <div class="servicio">
            ...
            <button class="btn-servicios" onclick="services('p=desarrolloweb')" id="btn-service" ><a id="e" href="" p=>Ver</a></button>
        </div>
        <div class="servicio">
            ...
            <button class="btn-servicios"  onclick="services('p=ecomerce')" id="btn-service" ><a id="e">Ver</a></button>
        </div>
        <div class="servicio">
            ...
            <button class="btn-servicios" onclick="services('p=medida')" id="btn-service" ><a id="e">Ver</a></button>
        </div>
        <div class="servicio">
            ...
            <button class="btn-servicios" onclick="services('p=classroom')" id="btn-service" ><a id="e">Ver</a></button>
        </div>
    </section>
    <?php
    footer();
